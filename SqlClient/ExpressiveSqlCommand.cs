...
namespace Open.Database.Extensions.SqlClient
{
    ...
    public class ExpressiveSqlCommand : ExpressiveAsyncCommandBase<SqlConnection, SqlCommand, SqlDbType, ExpressiveSqlCommand>
    {
        ...
        public override ISourceBlock<T> AsSourceBlockAsync<T>(IEnumerable<(string Field, string Column)> fieldMappingOverrides)
        {
        ...
        public override Task<IEnumerable<T>> ResultsAsync<T>(IEnumerable<(string Field, string Column)> fieldMappingOverrides)
