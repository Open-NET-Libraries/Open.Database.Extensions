...
namespace Open.Database.Extensions
{
	...
	public static partial class SqlConnectionExtensions
	{
		...
		public static ExpressiveSqlCommand Command(
			...
			=> new ExpressiveSqlCommand(connection, type, command);
		...
		public static ExpressiveSqlCommand Command(
			...
			string command, CommandType type = CommandType.Text)
			=> new ExpressiveSqlCommand(transaction, type, command);
		...
		public static ExpressiveSqlCommand StoredProcedure(
			...
			=> new ExpressiveSqlCommand(connection, CommandType.StoredProcedure, procedureName);
		...
		public static ExpressiveSqlCommand StoredProcedure(
			this SqlTransaction transaction,
			string procedureName)
			=> new ExpressiveSqlCommand(transaction, CommandType.StoredProcedure, procedureName);
